...
The docker is binding the above ports to your host machine automatically so you just have to open the following ports on your machine where cudos nodes are running.
