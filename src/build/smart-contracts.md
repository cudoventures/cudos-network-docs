...
Update all dependencies in the lockfile for cargo and rustup:
```
cargo update
rustup update
```
...
* [Base](https://github.com/CosmWasm/cw-plus/blob/main/packages/cw20/README.md#base)
* [Allowances](https://github.com/CosmWasm/cw-plus/blob/main/packages/cw20/README.md#allowances)
* [Mintable](https://github.com/CosmWasm/cw-plus/blob/main/packages/cw20/README.md#mintable)
...
* Clone the [cw-plus](https://github.com/CosmWasm/cw-plus) repo with [release tag of v0.9.1](https://github.com/CosmWasm/cw-plus/tree/v0.9.0) by running the command:
```
git clone --depth 1 --branch v0.9.1 https://github.com/CosmWasm/cw-plus.git
```
